#Cross Validation on LinearRegression for classification
...
outdir = f'/home/users/ubaldi/TESI_PA/result_CV/Regressin_OS/Public/large_space_change_expl_TTS_rand_state/{name}_stability_OS_regression'
