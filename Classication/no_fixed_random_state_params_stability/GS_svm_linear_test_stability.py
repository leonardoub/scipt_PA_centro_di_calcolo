...
for i in range(1, 11):
       ...
       #SVM
       steps = [('scaler', StandardScaler()), ('red_dim', PCA()), ('clf', SVC(kernel='linear', max_iter=10000))]
       ...
       file_best_params = open(f'/home/users/ubaldi/TESI_PA/result_CV/NO_fixed_rand_state/lin_svm_stability/best_params_rs{i*1000}_acc_{score}.txt', 'w')
