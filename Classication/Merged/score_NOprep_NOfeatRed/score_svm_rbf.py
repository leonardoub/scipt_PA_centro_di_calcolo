...
for i in range(1,31):
    ...
    #train test split 
    X_train, X_test, y_train, y_test = train_test_split(tot_data, tot_label, test_size=0.3, stratify=tot_label)
    ...
    outdir = '/home/users/ubaldi/TESI_PA/result_score/Merged/score_NOprep_NOfeatRed/report_svm_rbf_NO_NO'
