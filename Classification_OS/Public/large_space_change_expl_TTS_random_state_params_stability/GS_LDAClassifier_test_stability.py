...
outname = 'best_params_LDAClassifier_OS_4_classes.csv'

outdir = '/home/users/ubaldi/TESI_PA/result_CV/4_classes_OS/Public/large_space_change_expl_TTS_rand_state/LDAClassifier_stability_OS_4'
