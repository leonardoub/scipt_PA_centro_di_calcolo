...
for i in ['Train_PA_Test_PU_OS_1_2', 'Train_PU_Test_PA_OS_1_2']:
    
    path = f'/home/leonardo/Scrivania/result_PA/06_03/result_CV_bis/2_classes_OS/{i}/*/*.csv'
    ...
    #    my_dict['SCALER'].append(data['SCALER'][0])
        ...
        my_dict['ROC_AUC_TRAIN_MEAN'].append(data['roc_auc_train_mean'][0])
        my_dict['ROC_AUC_TRAIN_STD'].append(data['roc_auc_train_std'][0])
        my_dict['ROC_AUC_TEST_MEAN'].append(data['roc_auc_test_mean'][0])
        my_dict['ROC_AUC_TEST_STD'].append(data['roc_auc_test_std'][0])
    ...
    outname = f'summary_scores_2OS_{i}.csv'
