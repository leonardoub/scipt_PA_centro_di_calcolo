...
for i in range(1,31):
    ...
    outdir = '/home/users/ubaldi/TESI_PA/result_score/Merged/score_NOprep_NOfeatRed/report_RadiusNeighbors_NO_NO'
...
outname = 'score_RadiusNeighbors_NO_NO.csv'

outdir = '/home/users/ubaldi/TESI_PA/result_score/Merged/score_NOprep_NOfeatRed/'
if not os.path.exists(outdir):
    os.makedirs(outdir)
