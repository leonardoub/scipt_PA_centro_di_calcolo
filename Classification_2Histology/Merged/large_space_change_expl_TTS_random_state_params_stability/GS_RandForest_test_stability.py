...
outname = 'best_params_RandomForest_2_classes_merged.csv'

outdir = '/home/users/ubaldi/TESI_PA/result_CV/2_classes_H/Merged/large_space_change_expl_TTS_rand_state/RandomForest_stability'
