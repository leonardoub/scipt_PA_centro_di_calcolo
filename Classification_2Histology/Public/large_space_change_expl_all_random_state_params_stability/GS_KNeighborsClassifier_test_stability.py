...
outname = 'best_params_KNeighbors.csv'

outdir = '/home/users/ubaldi/TESI_PA/result_CV/2_classes_H/Public/large_space_change_expl_all_rand_state/KNeighbors_stability_2_classes'
