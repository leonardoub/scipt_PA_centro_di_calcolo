...
path = '/home/leonardo/Scrivania/result_PA/06_03/score_ROC_AUC_optimization_using_all_HP_sets_USING_MEAN/3_classes_H/summary_scores_3H_MERGED.csv'


df = pd.read_csv(path, index_col = 'Unnamed: 0')

df.drop('SVM_sigmoid_MERGED_3_classes', inplace=True)


name_clf=[name[:-17] for name in df.index]
name_clf_bis=[]
