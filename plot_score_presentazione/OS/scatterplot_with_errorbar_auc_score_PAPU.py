...
path = '/home/leonardo/Scrivania/result_PA/06_03/score_ROC_AUC_optimization_using_all_HP_sets_USING_MEAN/2_classes_OS/summary_scores_2OS_Train_PA_Test_PU_OS_1_2.csv'


df = pd.read_csv(path, index_col = 'Unnamed: 0')

df.drop('SVM_sigmoid_OS_1_2_TRAIN_PA_TEST_PU', inplace=True)
