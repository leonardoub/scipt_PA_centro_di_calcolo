...
# -*- coding: utf-8 -*-
"""
Created on Tue May 19 18:06:33 2020
...
path = '/home/leonardo/Scrivania/result_PA/06_03/result_CV_bis/3_classes_H/*/*/*/*/*.csv'
...
####################################################    
    ...
    roc_auc_train_mean = data['train_roc_auc_ovr_weigthed_scores_predict_proba'].mean()
    roc_auc_test_mean = data['outer_loop_roc_auc_ovr_weigthed_scores_predict_proba'].mean()
    
    roc_auc_train_std = data['train_roc_auc_ovr_weigthed_scores_predict_proba'].std()
    roc_auc_test_std = data['outer_loop_roc_auc_ovr_weigthed_scores_predict_proba'].std()
    ...
    df_train_roc_auc_mean = pd.DataFrame([{'roc_auc_ovr_weigthed_train_mean':roc_auc_train_mean}])
    df_train_roc_auc_std = pd.DataFrame([{'roc_auc_ovr_weigthed_train_std':roc_auc_train_std}])
    
    df_test_roc_auc_mean = pd.DataFrame([{'roc_auc_ovr_weigthed_test_mean':roc_auc_test_mean}])
    df_test_roc_auc_std = pd.DataFrame([{'roc_auc_ovr_weigthed_test_std':roc_auc_test_std}])
