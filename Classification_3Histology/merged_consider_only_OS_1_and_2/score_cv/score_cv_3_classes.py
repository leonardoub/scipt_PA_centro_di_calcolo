...
def function_score_cv_3_classes(data, labels, pipel):
    ...
    for train_index, test_index in outer_kf.split(data, labels_encoded):
        ...
        'train_ROC_AUC_ovr_weigthed_score':tot_train_ROC_AUC, 'test_ROC_AUC_ovr_weigthed_score':tot_test_ROC_AUC}
        ...
        mean_std_dict = {'train_accuracy_MEAN':[mean_train_acc], 'train_accuracy_STD':[std_train_acc],
         ...
         'train_ROC_AUC_ovr_weigthed_score_MEAN':[mean_train_ROC_AUC], 'train_ROC_AUC_ovr_weigthed_score_STD':[std_train_ROC_AUC],
         'test_ROC_AUC_ovr_weigthed_score_MEAN':[mean_test_ROC_AUC], 'test_ROC_AUC_ovr_weigthed_score_STD':[std_test_ROC_AUC]}
