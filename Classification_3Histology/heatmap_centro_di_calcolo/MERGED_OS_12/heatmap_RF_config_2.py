...
n_tree = [5, 10, 15, 30, 45, 60, 75, 90, 105, 120, 140, 160, 180, 200, 500]
depth = [ 2, 5, 10, 15, 20, 30, 45, 60, 80, 100, 120, 140, 160, 180, None]
...
for i in range(1,6):
    ...
    outer_kf = KFold(n_splits=5, shuffle=True, random_state=2*i)
    ...
    outdir = f'/home/users/ubaldi/TESI_PA/fig_heatmap/PA/3H/MERGED_OS12/{name_clf}/config_2/'
