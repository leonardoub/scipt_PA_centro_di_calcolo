...
for i in range(1, 21):
       ...
       #SVM
       steps = [('scaler', MinMaxScaler()), ('red_dim', KernelPCA()), ('clf', LinearSVC(loss='hinge', random_state=i*503))]

       pipeline = Pipeline(steps)

       n_features_to_test = np.arange(1, 11)

       parameteres = [{'scaler':[MinMaxScaler()], 'red_dim':[KernelPCA(random_state=i*42)],
