...
for i in range(1, 21):
       ...
       #SVM
       steps = [('scaler', StandardScaler()), ('clf', SVC(kernel='linear'))]

       pipeline = Pipeline(steps)

       n_features_to_test = np.arange(1, 11)

       parameteres = [{'scaler':[StandardScaler()], 'clf__C':list(C_range)}]
...
outname = 'best_params_svm_lin_STDS_KW.csv'

outdir = '/home/users/ubaldi/TESI_PA/result_CV/3_classes_H/Public/only_KW_f_red_change_expl_TTS_rand_state/lin_svm_stability'
