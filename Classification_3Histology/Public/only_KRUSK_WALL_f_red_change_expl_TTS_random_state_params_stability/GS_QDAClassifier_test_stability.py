...
outname = 'best_params_QDAClassifier_KW.csv'

outdir = '/home/users/ubaldi/TESI_PA/result_CV/3_classes_H/Public/only_KW_f_red_change_expl_TTS_rand_state/QDAClassifier_stability'
