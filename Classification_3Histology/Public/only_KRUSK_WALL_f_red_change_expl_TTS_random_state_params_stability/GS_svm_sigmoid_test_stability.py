...
for i in range(1, 21):
       ...
       #SVM
       steps = [('scaler', StandardScaler()), ('clf', SVC(kernel='sigmoid'))]
...
outname = 'best_params_svm_sigmoid_KW.csv'

outdir = '/home/users/ubaldi/TESI_PA/result_CV/3_classes_H/Public/only_KW_f_red_change_expl_TTS_rand_state/sigmoid_svm_stability'
