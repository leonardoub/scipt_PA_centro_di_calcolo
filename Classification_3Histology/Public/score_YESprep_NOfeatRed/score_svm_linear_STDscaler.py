...
for i in range(1,31):
    ...
    outdir = '/home/users/ubaldi/TESI_PA/result_score/Public/score_YESprep_NOfeatRed/report_svm_linear_YES_NO_STDscaler'
...
outdir = '/home/users/ubaldi/TESI_PA/result_score/Public/score_YESprep_NOfeatRed/'
if not os.path.exists(outdir):
    os.makedirs(outdir)
