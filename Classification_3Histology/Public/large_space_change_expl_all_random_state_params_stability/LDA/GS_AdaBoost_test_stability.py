...
for i in range(1, 21):
       ...
       #RadiusNeighbors
       steps = [('scaler', MinMaxScaler()), ('red_dim', LinearDiscriminantAnalysis()), ('clf', AdaBoostClassifier(random_state=i*503))]
...
outdir = '/home/users/ubaldi/TESI_PA/result_CV/3_classes_H/Public/large_space_change_expl_TTS_rand_state/AdaBoost_stability'
