...
for i in range(1, 21):
       ...
       steps = [('scaler', MinMaxScaler()), ('red_dim', LinearDiscriminantAnalysis()), ('clf', KNeighborsClassifier())]
       ...
       parameteres = [{'scaler':scalers_to_test, 'red_dim':[LinearDiscriminantAnalysis()], 'red_dim__n_components':[2], 'clf__n_neighbors':k, 
                       ...
                       {'scaler':scalers_to_test, 'red_dim':[LinearDiscriminantAnalysis()], 'red_dim__n_components':[2], 'clf__n_neighbors':k, 
