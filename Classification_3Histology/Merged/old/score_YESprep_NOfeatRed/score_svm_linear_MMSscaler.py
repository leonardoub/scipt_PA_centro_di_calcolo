...
for i in range(1,31):
    ...
    outdir = '/home/users/ubaldi/TESI_PA/result_score/Merged/score_YESprep_NOfeatRed/report_svm_linear_YES_NO_MMSscaler'
...
outname = 'score_svm_linear_YES_NO_MMSscaler.csv'
