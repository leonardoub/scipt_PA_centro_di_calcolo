...
for i in range(1,31):
    ...
    #train test split 
    X_train, X_test, y_train, y_test = train_test_split(tot_data, tot_label, test_size=0.3, stratify=tot_label, random_state=i*500)
    ...
    outdir = '/home/users/ubaldi/TESI_PA/result_score/Merged/score_YESprep_NOfeatRed/report_svm_linear_YES_NO_STDscaler'
...
outname = 'score_svm_linear_YES_NO_STDscaler.csv'

outdir = '/home/users/ubaldi/TESI_PA/result_score/Merged/score_YESprep_NOfeatRed/'
if not os.path.exists(outdir):
    os.makedirs(outdir)
