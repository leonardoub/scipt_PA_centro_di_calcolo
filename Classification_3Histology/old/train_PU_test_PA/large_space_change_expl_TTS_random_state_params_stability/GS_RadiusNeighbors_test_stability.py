...
for i in range(1, 21):
       ...
       parameteres = [{'scaler':scalers_to_test, 'red_dim':[PCA()], 'red_dim__n_components':n_features_to_test, 'clf__radius':R, 
...
outname = 'best_params_RadiusNeighbors_2_classes_merged.csv'

outdir = '/home/users/ubaldi/TESI_PA/result_CV/2_classes_H/Merged/large_space_change_expl_TTS_rand_state/RadiusNeighbors_stability'
